...
Say:
> Last step — Career Claude needs four knowledge files.
>
> In your project, find the **Knowledge** section and upload these four files from the Career Claude repository (one at a time):
>
...
>
> Reply "done" when all four are uploaded.
